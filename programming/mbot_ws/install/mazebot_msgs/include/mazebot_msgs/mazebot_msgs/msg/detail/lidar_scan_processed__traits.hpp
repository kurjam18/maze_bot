...
#ifndef MAZEBOT_MSGS__MSG__DETAIL__LIDAR_SCAN_PROCESSED__TRAITS_HPP_
#define MAZEBOT_MSGS__MSG__DETAIL__LIDAR_SCAN_PROCESSED__TRAITS_HPP_
...
inline std::string to_yaml(const LidarScanProcessed & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const mazebot_msgs::msg::LidarScanProcessed & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mazebot_msgs::msg::LidarScanProcessed & msg)
{
  return mazebot_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<mazebot_msgs::msg::LidarScanProcessed>()
{
  return "mazebot_msgs::msg::LidarScanProcessed";
}

template<>
inline const char * name<mazebot_msgs::msg::LidarScanProcessed>()
{
  return "mazebot_msgs/msg/LidarScanProcessed";
}

template<>
struct has_fixed_size<mazebot_msgs::msg::LidarScanProcessed>
  : std::integral_constant<bool, has_fixed_size<sensor_msgs::msg::LaserScan>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<mazebot_msgs::msg::LidarScanProcessed>
  : std::integral_constant<bool, has_bounded_size<sensor_msgs::msg::LaserScan>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<mazebot_msgs::msg::LidarScanProcessed>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MAZEBOT_MSGS__MSG__DETAIL__LIDAR_SCAN_PROCESSED__TRAITS_HPP_
