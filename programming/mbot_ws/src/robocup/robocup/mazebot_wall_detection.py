...
class MazeBotWallDetection(Node):
    ...
    def detect_neighbour_walls(self, msg):
        ...
        return (front_wall_detection, rear_wall_detection, left_wall_detection, right_wall_detection)
    ...
    def lidar_callback(self,msg):
        ...
        print("CURRENT FIELD:")
        print("Front: distance=%.2f" % mazebot_field_orientation.front_distance, "tangent=%.2f" % front_wall_angle)
        print("Rear:  distance=%.2f" % mazebot_field_orientation.rear_distance,  "tangent=%.2f" % rear_wall_angle)
        print("Left:  distance=%.2f" % mazebot_field_orientation.left_distance,  "tangent=%.2f" % left_wall_angle)
        print("Right: distance=%.2f" % mazebot_field_orientation.right_distance, "tangent=%.2f" % right_wall_angle)     
