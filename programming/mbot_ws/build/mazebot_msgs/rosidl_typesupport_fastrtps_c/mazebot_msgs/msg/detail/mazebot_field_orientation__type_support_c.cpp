...
#include "mazebot_msgs/msg/detail/mazebot_field_orientation__rosidl_typesupport_fastrtps_c.h"
...
using _MazebotFieldOrientation__ros_msg_type = mazebot_msgs__msg__MazebotFieldOrientation;

static bool _MazebotFieldOrientation__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MazebotFieldOrientation__ros_msg_type * ros_message = static_cast<const _MazebotFieldOrientation__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: front_angle_deg
  {
    cdr << ros_message->front_angle_deg;
  }

  // Field name: rear_angle_deg
  {
    cdr << ros_message->rear_angle_deg;
  }
...
static bool _MazebotFieldOrientation__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _MazebotFieldOrientation__ros_msg_type * ros_message = static_cast<_MazebotFieldOrientation__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_mazebot_msgs__msg__MazebotFieldOrientation(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MazebotFieldOrientation__ros_msg_type * ros_message = static_cast<const _MazebotFieldOrientation__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name front_angle_deg
  {
    size_t item_size = sizeof(ros_message->front_angle_deg);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name rear_angle_deg
  {
    size_t item_size = sizeof(ros_message->rear_angle_deg);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name left_angle_deg
...
static uint32_t _MazebotFieldOrientation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mazebot_msgs__msg__MazebotFieldOrientation(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mazebot_msgs
size_t max_serialized_size_mazebot_msgs__msg__MazebotFieldOrientation(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MazebotFieldOrientation__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_mazebot_msgs__msg__MazebotFieldOrientation(
...
static message_type_support_callbacks_t __callbacks_MazebotFieldOrientation = {
  "mazebot_msgs::msg",
  "MazebotFieldOrientation",
  _MazebotFieldOrientation__cdr_serialize,
  _MazebotFieldOrientation__cdr_deserialize,
  _MazebotFieldOrientation__get_serialized_size,
  _MazebotFieldOrientation__max_serialized_size
};

static rosidl_message_type_support_t _MazebotFieldOrientation__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MazebotFieldOrientation,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mazebot_msgs, msg, MazebotFieldOrientation)() {
  return &_MazebotFieldOrientation__type_support;
}
