...
class Metaclass_MazebotFieldOrientation(type):
    """Metaclass of message 'MazebotFieldOrientation'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mazebot_msgs.msg.MazebotFieldOrientation')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mazebot_field_orientation
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mazebot_field_orientation
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mazebot_field_orientation
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mazebot_field_orientation
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mazebot_field_orientation
...
class MazebotFieldOrientation(metaclass=Metaclass_MazebotFieldOrientation):
    """Message class 'MazebotFieldOrientation'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.front_angle_deg = kwargs.get('front_angle_deg', float())
        self.rear_angle_deg = kwargs.get('rear_angle_deg', float())
    ...
    def __eq__(self, other):
        ...
        if self.right_distance != other.right_distance:
            return False
        if self.front_angle_deg != other.front_angle_deg:
            return False
        if self.rear_angle_deg != other.rear_angle_deg:
            return False
    ...
    @builtins.property
    def front_angle_deg(self):
        """Message field 'front_angle_deg'."""
        return self._front_angle_deg

    @front_angle_deg.setter
    def front_angle_deg(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'front_angle_deg' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'front_angle_deg' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._front_angle_deg = value

    @builtins.property
    def rear_angle_deg(self):
        """Message field 'rear_angle_deg'."""
        return self._rear_angle_deg

    @rear_angle_deg.setter
    def rear_angle_deg(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'rear_angle_deg' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'rear_angle_deg' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._rear_angle_deg = value
