...
bool mazebot_msgs__msg__lidar_scan_processed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mazebot_msgs.msg._lidar_scan_processed.LidarScanProcessed", full_classname_dest, 57) == 0);
  }
  mazebot_msgs__msg__LidarScanProcessed * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LidarScanProcessed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mazebot_msgs.msg._lidar_scan_processed");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LidarScanProcessed");
