...
static const _MazebotFieldOrientation_type_support_symbol_names_t _MazebotFieldOrientation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mazebot_msgs, msg, MazebotFieldOrientation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mazebot_msgs, msg, MazebotFieldOrientation)),
  }
};
...
{
  return &::mazebot_msgs::msg::rosidl_typesupport_cpp::MazebotFieldOrientation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mazebot_msgs, msg, MazebotFieldOrientation)() {
  return get_message_type_support_handle<mazebot_msgs::msg::MazebotFieldOrientation>();
}
